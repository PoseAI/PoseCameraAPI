// Copyright Pose AI 2022.  All Rights Reserved.
...
#include "AnimGraphNode_PoseAIHandTarget.generated.h"

// actor class used for bone selector
#define ABoneSelectActor ATargetPoint

class FPoseAIHandTargetDelegate;
class IDetailLayoutBuilder;

UCLASS(MinimalAPI)
class UAnimGraphNode_PoseAIHandTarget : public UAnimGraphNode_SkeletalControlBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(EditAnywhere, Category=Settings)
	FAnimNode_PoseAIHandTarget Node;
	...
	static TSharedPtr<class FPoseAIHandTargetDelegate> PoseAIHandTargetDelegate;
